...
const styles={
  offDealCards:"rounded-lg w-[280px] h-[400px] flex flex-col justify-between bg-[#f2e4d9] overflow-hidden",
                ...
                offData.map((data, ind) => {
                    return (
                            <div className={styles.offDealCards}>
                                ...
                                <Image src={data.img} alt="sdasd" height={100} width={100} className="w-full h-[48%]"/>
                            </div>
                    )
                })
            }
